...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ULTIMATEATK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ULTIMATEATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ULTIMATEATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ULTIMATEATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ULTIMATEATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ULTIMATEATK actions', async () => {
      const expectedActions = [
        {
