...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARACTERCARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHARACTERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHARACTERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHARACTERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHARACTERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHARACTERCARD actions', async () => {
      const expectedActions = [
        {
