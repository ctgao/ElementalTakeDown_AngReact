...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './damage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DAMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DAMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DAMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DAMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DAMAGE actions', async () => {
      const expectedActions = [
        {
