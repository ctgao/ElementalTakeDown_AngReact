  ...
  return (
    <div>
      <h2 id="skill-atk-heading" data-cy="SkillATKHeading">
        <Translate contentKey="elementaltakedownApp.skillATK.home.title">Skill ATKS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="elementaltakedownApp.skillATK.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/skill-atk/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="elementaltakedownApp.skillATK.home.createLabel">Create new Skill ATK</Translate>
          </Link>
        </div>
      </h2>
        ...
        {skillATKList && skillATKList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="elementaltakedownApp.skillATK.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="elementaltakedownApp.skillATK.home.notFound">No Skill ATKS found</Translate>
            </div>
          )
        )}
      </div>
