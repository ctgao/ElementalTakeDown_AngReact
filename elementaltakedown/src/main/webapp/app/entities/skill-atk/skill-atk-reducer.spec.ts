...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './skill-atk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKILLATK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKILLATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKILLATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKILLATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKILLATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKILLATK actions', async () => {
      const expectedActions = [
        {
