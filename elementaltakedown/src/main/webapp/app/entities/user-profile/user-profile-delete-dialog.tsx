...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="elementaltakedownApp.userProfile.delete.question">
        <Translate contentKey="elementaltakedownApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
