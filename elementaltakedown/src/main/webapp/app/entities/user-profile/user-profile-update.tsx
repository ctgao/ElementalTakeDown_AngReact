  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          cards: userProfileEntity?.cards?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="elementaltakedownApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
            <Translate contentKey="elementaltakedownApp.userProfile.home.createOrEditLabel">Create or edit a UserProfile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('elementaltakedownApp.userProfile.name')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('elementaltakedownApp.userProfile.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('elementaltakedownApp.userProfile.cards')}
