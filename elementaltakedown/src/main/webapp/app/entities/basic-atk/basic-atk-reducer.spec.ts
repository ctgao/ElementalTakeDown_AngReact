...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './basic-atk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASICATK_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASICATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASICATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASICATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASICATK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASICATK actions', async () => {
      const expectedActions = [
        {
